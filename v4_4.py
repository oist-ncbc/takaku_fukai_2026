...
def main():
    ...
    # model_path = 'model/PFCHPC_30_131/v4_3_N30_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch195.pth'
    # model_path ='model/PFCHPC_30_131/v4_3_N30_131_s7_100_1_epoch195.pth'
    # model_path ='model_deigo/PFCHPC_30_151/v4_3_N30_151_s2_100_1_epoch195.pth'
    ...
    for epoch in range(epochs_num):
        ...
        for i in range(int(training_size / batch_size)):
            ...
            if np.random.randint(1, 3) == 1:
                data = mkOwnRandomBatch(train_x, train_x, batch_size)
            else:
                data = mkOwnRandomBatch(train_y, train_y, batch_size)
        ...
        if epoch % 5 == 0:
            ...
            if correct_num > -1 or epoch == 50:
                # model_path = 'model/PFCHPC30_131_bigbatch/v4_3_N30_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(epoch+0)+'.pth'
                model_path = 'model/PFCHPC30_traintest/v4_3_N30_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(epoch+195)+'.pth'
                # model_path = 'model/PFCHPC_30_transfer_1'+str(delay_length)+'1/v4_3_N30_1'+str(delay_length)+'1_transfers11_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(epoch)+'.pth'
                # model_path = 'model/compare_H/Compare_1'+str(delay_length)+'1H_s10_100_10_'+str(sparse)+'_epoch'+str(epoch+0)+'.pth'
                torch.save(rnn.state_dict(), model_path)
                s = str(epoch) + "," + str(correct_num) + "," + model_path +"\n"
                with open("model/PFCHPC30_traintest/correct_list.txt", mode="a") as f:
                    f.write(s)
