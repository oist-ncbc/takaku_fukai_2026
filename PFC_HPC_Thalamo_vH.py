...
def mkOwnDataSet_auto(data_size, delay_length, freq=60., noise=0.00001):
...
def main():
    ...
    # model_path,past_epochnum = choose_maxmodel("model/R20_H/",sparse,index_num)
    ...
    for epoch in range(epochs_num):
        ...
        for i in range(int(training_size / batch_size)):
            ...
            ids = np.random.randint(1,data.shape[0]-2,(50))
        ...
        if epoch % 5 == 0:
            ...
            if correct_num > -1 or epoch == 50:
                # model_path = 'model/R20_H_transfer2B/ReModel_L2_interRNNrand_OUT1_transfers14_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(0+epoch)+'.pth'
                ...
                with open("model/R20_uniHPC_H/correct_list.txt", mode="a") as f:
                    f.write(s)
