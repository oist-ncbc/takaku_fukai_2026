...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 14 12:03:41 2023
...
#v3 revised training part to avoid implace error
...
def main():
    ...
    optimizer = optim.Adam(rnn.parameters(), lr=0.0001, weight_decay=1e-8)
    ...
    model_path = 'model/compare30_traintest/compare30_131_s'+str(sparse)+'_100_'+str(indexnum)+'_epoch195.pth'
    ...
    for epoch in range(epochs_num):
        ...
        if epoch % 5 == 0:
            ...
            if correct_num > -1 or epoch == 50:
                ...
                model_path = 'model/compare30_traintest/compare30_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(indexnum)+'_epoch'+str(epoch+195)+'.pth'
                ...
                with open("model/compare30_traintest/correct_list.txt", mode="a") as f:
                    f.write(s)
