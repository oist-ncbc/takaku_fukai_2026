...
def main():
    ...
    rnn = MyLSTM_cue2(inputsize, hidden_size, outputsize, batch_size)
    ...
    # model_path = 'model/compare30_cue_131/Compare30_cue_131_s'+str(sparse)+'_100_'+str(index_num)+'_epoch195.pth'
    ...
    for epoch in range(epochs_num):
        ...
        if epoch % 5 == 0:
            ...
            for k in range(data_limit):
                    ...
                    output_test = torch.cat([output_test,torch.zeros(10,1)],axis=1)
            for k in range(data.shape[0]*5):
                    ...
                    if k == (delay_length+1)*20 or k == (delay_length*2+2)*20 or k == (delay_length*3+3)*20:
                        output_test = torch.cat([output,torch.ones(10,1)],axis=1)
                    else:
                        output_test = torch.cat([output,torch.zeros(10,1)],axis=1)
            ...
            if correct_num > -1 or epoch == 50:
                ...
                model_path = 'model/compare30_cue_131_cue2/Compare30_cue_131_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(0+epoch)+'.pth'
                ...
                with open("model/compare30_cue_131_cue2/correct_list.txt", mode="a") as f:
                    f.write(s)
        

    
    # model_path = 'model/ReModel_interRNNrand_AddRe_OUT5_long131test_s'+str(sparse)+'_100_1.pth'
    model_path = 'model/compare30_cue_131_cue2/Compare30_cue7_s'+str(sparse)+'_100_'+str(index_num)+'.pth'
