...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 16:49:58 2023
...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  7 14:59:54 2022
...
def main():
    ...
    # model_path = 'model/PFCHPC_30_cue_131/v4_3_N30_cue_131_s'+str(sparse)+'_100_'+str(index_num)+'_epoch195.pth'
    # model_path = 'model/PFCHPC30_cue_1until3_smallbatch5_decay/v4_3_N30_cue_131_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(195)+'.pth'
    ...
    for epoch in range(epochs_num):
        ...
        if epoch % 5 == 0:
            ...
            if correct_num > -1 or epoch == 50:
                model_path = 'model/PFCHPC30_cue_1until3_smallbatch5_decay/v4_3_N30_cue_131_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(epoch+0)+'.pth'
                ...
                with open("model/PFCHPC30_cue_1until3_smallbatch5_decay/correct_list.txt", mode="a") as f:
                    f.write(s)
