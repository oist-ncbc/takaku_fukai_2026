...
def main():
    ...
    model_path,past_epochnum = choose_maxmodel("model/R20_H_uniHPC_bigbatch/",sparse,index_num)
    ...
    for epoch in range(epochs_num):
        ...
        if epoch % 5 == 0:
            ...
            if correct_num > -1 or epoch == 50:
                # model_path = 'model/R20_H_bigbatch/ReModel_L2_interRNNrand_OUT1_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(past_epochnum+epoch)+'.pth'
                model_path = 'model/R20_H_uniHPC_bigbatch/ReModel_L2_interRNNrand_OUT1_1'+str(delay_length)+'1_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(past_epochnum+epoch)+'.pth'
                ...
                # model_path = 'model/R20_H_uniHPC_bigbatch/ReModel_L2_interRNNrand_OUT1_1'+str(delay_length)+'1H_s'+str(sparse)+'_100_'+str(index_num)+'_epoch'+str(past_epochnum+epoch)+'.pth'
                ...
                with open("model/R20_H_uniHPC_bigbatch/correct_list.txt", mode="a") as f:
                    f.write(s)
